...
\def\elementAA{\textbf{\author} \\ k12105003}

\def\elementB{Submission / Angefertigt am}
\def\elementBB{\textbf{Institute of Numerical Analysis}}

\def\elementC{Thesis Supervisor / First Supervisor / BeurteilerIn / ErstbeurteilerIn / ErstbetreuerIn}
\def\elementCC{DI~Dr.\@ \textbf{Andreas Schafelner}}
...
\def\subtitle{Modelling of linear RLC circuits by means of differential algebraic equations}
