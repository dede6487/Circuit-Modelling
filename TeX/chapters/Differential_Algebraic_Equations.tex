...
\paragraph{index $\nu = 0$. } this case leads to an ODE, and Picard-Lindelöff t theorem \protecting{\cite[Satz~1.2.1]{NumerikGewöhnlicherDifferentialgleichungen}} tells us that every initial condition is consistent, we only consider index $\nu = 1$ and $\nu = 2$.
