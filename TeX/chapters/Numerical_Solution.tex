...
\section{Numerical Examples}
	...
	The MNA-system for this example reads
	...
	\end{figure}
	 ...
	 Of course we still need to find consistent initial values. This can be done by means of Section \ref{sec:consistant initial values}
	
	\begin{table}[H]
		\resizebox*{\textwidth}{!}{%
			\csvreader[tabular= | c || c c c | c c c | c c c | c c c |,
			table head = \hline h & \multicolumn{3}{c|}{k = 1} & \multicolumn{3}{c|}{k = 2} & \multicolumn{3}{c|}{k = 3} & \multicolumn{3}{c|}{trapezoidal}\\
			& u1 & u2 & iV & u1 & u2 & iV & u1 & u2 & iV & u1 & u2 & iV \\
			\hline,
