...
\section{Numerical Examples}
	...
	\begin{table}[H]
		\resizebox*{\textwidth}{!}{%
			...
			& u1 & u2 & iL & u1 & u2 & iL & u1 & u2 & iL & u1 & u2 & iL \\
			\hline,
			late after line=\\\hline]
			{../Matlab/err_ex1_test.csv}{h=\h, oneu=\oneu, oneuu=\oneuu, onei=\onei, twou=\twou, twouu=\twouu, twoi=\twoi, threeu=\threeu, threeuu=\threeuu, threei=\threei, trapu=\trapu, trapuu=\trapuu, trapil=\trapil}
			{\h & \num{\oneu} & \num{\oneuu} & \num{\onei} & \num{\twou} & \num{\twouu} & \num{\twoi} & \num{\threeu} & \num{\threeuu} & \num{\threei} & \num{\trapu} & \num{\trapuu} & \num{\trapil}}
		}
	\end{table}
