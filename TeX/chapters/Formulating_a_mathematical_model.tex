...
Again using KCL \ref{KCL} and the component equations we formulate a system of equations. This time we use the charge and flux based formulations. This means that instead of directly using current and voltage we use the flux of the electric field (used in the description of inductances) and the charge (used in the description of capacitors). We obtain
