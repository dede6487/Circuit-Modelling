...
\begin{example1}[Incidence Matrix]
...
\begin{example2}[Incidence Matrix]
...
\begin{example3}[Incidence Matrix]
...
\begin{example1}[Modified Nodal Analysis System]
	\label{ex:MNA}
...
\begin{example2}[Modified Nodal Analysis System]
	\label{ex:LC-circuit MNA}
	Similarly we also derived the incidence Matrix for this system in Example 2.\ref{ex:LC-circuit incidence matrix}.
	\begin{displaymath}
		A = 
		\left(
		\begin{matrix}
...
\begin{example3}[Modified Nodal Analysis System]
	\label{ex:Example 3 - MNA}
	Consider the circuit of Example 3.\ref{ex:Example 3 - incidence matrix }. We have already found the incidence matrix for this circuit.
	\begin{displaymath}
		A = 
		\left(
		\begin{matrix}
