...
\begin{theorem}[Index-1 condition] \cite{Tischendorf2004Topological} \label{Index-1 condition}
...
\begin{theorem}[Index-2 condition] \cite{Tischendorf2004Topological} \label{Index-2 condition}
...
This means that for ``reasonable'' RLC circuits (satisfying the prerequisites from the above theorems) the index will not exceed 2. We will only consider such circuits.
